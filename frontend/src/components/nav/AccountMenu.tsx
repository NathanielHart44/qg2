...
export default function AccountMenu() {
    ...
    return (
        <Box component={'div'} sx={{ display: 'flex', alignItems: 'center', textAlign: 'center', mr: 1 }}>
            { isMobile ?
                <>
                    <IconButton
                        onClick={handleClick}
...
export function AvatarDisplay({ is_main, currentUser }: AvatarDisplayProps) {
    ...
    return (
        ...
        >
            <Typography variant={is_main ? "h6" : "body1"} fontFamily={"Mystery Quest"} sx={{ color: theme.palette.text.primary }}>
