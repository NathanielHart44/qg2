...
export default function CarouselArrows({
  ...
  if (children) {
    return (
      <Box component={'div' as any} {...other} sx={{ display: 'flex', justifyContent: 'center' }}>
        <Box component={'div'} className="arrow left" sx={{ ...style, left: 0 }}>
        ...
        <Box component={'div'} className="arrow right" sx={{ ...style, right: 0 }}>
